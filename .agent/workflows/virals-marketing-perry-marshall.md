---
description: Ativa o agente Perry Marshall
---

# Ativação do Agente Perry Marshall

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/marketing-perry-marshall.md`

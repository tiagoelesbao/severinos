---
description: Ativa o agente David Allen (Projetos)
---
# Activating @allen-proj

1. Use the run_command tool to execute the `generate-squad-greeting.js` script with Node.js.
```bash
node scripts/generate-squad-greeting.js "squads/virals-projetos-squad/agents/allen-proj.md"
```
...
agent:
  ...
  name: David
```
3. Read the agent's file `squads/virals-projetos-squad/agents/allen-proj.md` using the view_file tool to understand its capabilities if needed.

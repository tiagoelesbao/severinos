---
description: Ativa o agente Jeff Sutherland (Projetos)
---
# Activating @sutherland-proj

1. Use the run_command tool to execute the `generate-squad-greeting.js` script with Node.js.
```bash
node scripts/generate-squad-greeting.js "squads/virals-projetos-squad/agents/sutherland-proj.md"
```
...
agent:
  ...
  name: Jeff
```
3. Read the agent's file `squads/virals-projetos-squad/agents/sutherland-proj.md` using the view_file tool to understand its capabilities if needed.

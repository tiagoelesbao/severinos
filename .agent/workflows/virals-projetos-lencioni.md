---
description: Ativa o agente Patrick Lencioni (Projetos)
---
# Activating @lencioni-proj

1. Use the run_command tool to execute the `generate-squad-greeting.js` script with Node.js.
```bash
node scripts/generate-squad-greeting.js "squads/virals-projetos-squad/agents/lencioni-proj.md"
```
...
agent:
  ...
  name: Patrick
```
3. Read the agent's file `squads/virals-projetos-squad/agents/lencioni-proj.md` using the view_file tool to understand its capabilities if needed.

# Gemini Rules - Synkra AIOS (v1.2.0 - Sutherland v2.0 Ready)
...
## Virals Projetos Squad (v2.0)
- **Shaping:** `@singer-proj` define o appetite e o escopo do projeto.
- **Intelligence Council:** `@kaushik` e `@dalio` auditam o briefing para profundidade estratégica.
- **Advanced Charter:** Geração de Google Docs nativos com tabelas estilizadas.
- **Sutherland v2.0:** Automação via `create_milestones.js` para criar marcos nas listas de fase do ClickUp.
- **Lists:** Planejamento (`901324798948`), Execução (`901324798949`), Finalização (`901324798947`).

## Alternative Squad Creator (v4.0)
- **Agent:** `@squad-chief` (Squad Architect)
- **Path:** `squads/squad-creator-alternative/`
- **Focus:** Triage, Routing, and Template-Driven creation.
- **Capability:** Deep Tool Discovery (v2.6) with RICE/WSJF/Security scoring.

...
- **Ubicación:** Definido en `.aios-core/workflows/*.yaml` o secciones de workflow de stories
...
- Ubicación: `.aios-core/workflows/{workflow-name}.yaml`
...
3. **Gestión de Workflows AIOS:** Patrones de workflow existentes en AIOS

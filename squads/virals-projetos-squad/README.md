# Virals Projetos Squad (📋 Orquestrador)

> **"Do briefing ao resultado — com clareza, prazo e dono."**
...
- **@sutherland-proj** (Tier 1): Mestre de Execução (Scrum). Decompõe, prioriza backlog, remove impedimentos e conduz sprints (v2.0: Automação ClickUp).
...
### AI Intelligence Council (Consultores)

Integrados ao pipeline de Inteligência de Projetos:
- **@kaushik**: Análise de KPIs, métricas e viabilidade baseada em dados.
- **@dalio**: Análise de princípios, meritocracia de ideias e lógica sistêmica.
...
- `v1-internal-project-pipeline.yaml`: New 6-phase AI-driven pipeline

### Tools & Scripts

- `project_intelligence.js`: Orquestrador de Inteligência de Projetos (Extract -> Council -> Persist).
- `create_milestones.js`: Automação Sutherland v2.0 para criação de marcos no ClickUp.
...
- **AI Intelligence Council**: Briefings reviewed by Dalio & Kaushik for maximum strategic depth.
- **Advanced Project Charter**: Native Google Docs tables, styled headers, and automated sharing.
- **Sutherland v2.0 Milestones**: Automatically maps milestones to ClickUp phase lists (Planejamento, Execução, Finalização).

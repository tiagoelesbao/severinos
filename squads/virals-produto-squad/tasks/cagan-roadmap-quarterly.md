...
Registrar o roadmap executando o script `node services/clickup/tasks.js create --name "Novo Roadmap Trimestral" --department "Produto" --area "Gestão de Produtos" --process "Painel de Produtos"` e realizar o handoff para o time de marketing e vendas se preparar.

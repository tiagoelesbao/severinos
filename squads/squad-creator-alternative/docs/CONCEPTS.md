...
O modo Base e o padrao. O @squad-chief opera sozinho, utilizando templates obrigatorios (squad-tmpl.yaml, agent-tmpl.md, readme-tmpl.md) como fundacao para toda criacao. O usuario fornece domain knowledge (3 perguntas maximo) e o squad-chief complementa com pesquisa web.
...
```yaml
pro_detection:
  check: "squads/squad-creator-pro/squad.yaml"
  behavior:
...
|----------|-----------|----------|
| `squad-tmpl.yaml` | Estrutura do squad.yaml do squad | create-squad, create-template |

...
> - **PRO Mode:** Ativado quando `squads/squad-creator-pro/squad.yaml` existe. Habilita mind cloning, delegacao para especialistas (@oalanicolas, @pedro-valerio, @thiago_finch), e modos YOLO/QUALITY/HYBRID.
>
> Para verificar modo ativo: se `squads/squad-creator-pro/squad.yaml` existe, pro_mode=true.
...
| - Read() squad-tmpl.yaml antes de Write() squad.yaml                  |

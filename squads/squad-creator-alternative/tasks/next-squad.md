...
execution_path:
  if_action == FIX:
    ...
    example: "Fix cybersecurity squad.yaml syntax error"
    effort: S
...
Why: squad.yaml has YAML syntax error. Quick fix, immediate health gain.
Execute: Fix squads/cybersecurity/squad.yaml line 422-423

Quick Wins:
- [ ] cybersecurity: YAML syntax error → fix squad.yaml
- [ ] c-level: Missing squad.yaml → generate from template

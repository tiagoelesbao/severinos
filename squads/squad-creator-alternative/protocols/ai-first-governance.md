...
- `squads/{squad}/squad.yaml` and `squads/{squad}/squad.yaml` define structure truth.
...
- Before recommendations, resolve scope from canonical artifacts (`squad.yaml`, `squad.yaml`, agent/task/workflow files, registry entries).

...
error_categories:
  ...
  reference_errors:
    ...
    fix_strategy: "Scan squad.yaml dependencies, identify and report missing files"

  # Category 3: Configuration Errors
  config_errors:
    auto_fixable: "yes"
    examples:
      - "Invalid YAML syntax in squad.yaml"
...
fix_missing_field:
  ...
  steps:
    ...
    - "Check template (templates/squad-tmpl.yaml) for default value"

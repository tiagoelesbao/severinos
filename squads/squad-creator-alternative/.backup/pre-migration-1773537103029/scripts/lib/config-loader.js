 ...
 *
 * Detecta o root do projeto automaticamente e carrega paths do squad-squad.yaml.
...
function loadSquadConfig(projectRoot) {
  const configPath = path.join(projectRoot, 'squads', 'squad-creator', 'config', 'squad-squad.yaml');

...
- **Auto-deteccao:** Base detecta Pro automaticamente via `squads/squad-creator-pro/squad.yaml`.
...
| Template | Proposito |
|----------|-----------|
| squad-tmpl.yaml | Estrutura de squad.yaml |
...
```
squads/squad-creator-pro/squad.yaml → PRO_DETECTED
```

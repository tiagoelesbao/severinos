...
Todo squad criado deve declarar no `squad.yaml`:
...
- `squad-tmpl.yaml` - Template de configuração de squad
...
- `squad-squad.yaml` - Configuração de squad com data sources
...
Configure fontes de transcrição em `config/squad-squad.yaml`:

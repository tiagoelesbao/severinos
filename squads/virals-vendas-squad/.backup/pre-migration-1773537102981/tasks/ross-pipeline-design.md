...
Desenhar a visualização de colunas e campos customizados no sistema de gestão.
...
- [ ] **AC-3:** O funil está configurado no ClickUp com os campos necessários para o forecast.
